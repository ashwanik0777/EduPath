    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="hidden md:flex md:w-5/12 lg:w-1/2 bg-gradient-to-br from-amber-300 to-amber-400 flex-col justify-center p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md mx-auto">
          ...
          <div className="text-indigo-800 text-sm mt-auto">&copy;2025 LearnAI</div>
        </div>
      </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <Link href="/forgot-password" className="text-xs text-amber-300 hover:text-amber-200">Forgot password?</Link>
                </div>
                <Input
                  type="password"
