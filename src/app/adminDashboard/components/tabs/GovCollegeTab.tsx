...
type GovCollegeTabProps = {
  collegeForm: { name: string; type: string; category: string; city: string; state: string };
  setCollegeForm: React.Dispatch<React.SetStateAction<{ name: string; type: string; category: string; city: string; state: string }>>;
